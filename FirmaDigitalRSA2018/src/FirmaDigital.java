...
public class FirmaDigital {
	...
	private static final String PROTO1 = "SHA256WithRSA"; 
	...
	private static String firmar(String mensaje, KeyPair clave)throws Exception{
		...
		Signature firmaContainer=Signature.getInstance(PROTO1);
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println("Obteniendo generador de claves: "+ALG2);
		KeyPairGenerator keyPair = KeyPairGenerator.getInstance(ALG2);
